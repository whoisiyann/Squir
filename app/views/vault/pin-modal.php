<?php
/**
 * PIN prompt na lumalabas bago ma-reveal / ma-copy ang isang password.
 * I-require ito sa dulo ng views/vault/index.php.
 *
 * @var int $pinLength
 */
...
<div class="pin-modal-backdrop" id="pinModalBackdrop" aria-hidden="true">
    <div class="pin-modal" role="dialog" aria-modal="true" aria-labelledby="pinModalTitle">
        ...
        <p class="pin-modal-subtitle">Enter your PIN to view this password.</p>
