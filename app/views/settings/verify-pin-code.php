...
$codeLength = PinReset::CODE_LENGTH;
...
<body class="pin-page">
    <main class="login-shell">
        <section class="auth-card" aria-labelledby="verifyPinTitle">
            <div class="auth-visual" aria-label="Squir mascot">
                <img src="./assets/images/squir-login-signin-left-image.png" alt="Squir mascot">
            </div>

            <div class="auth-form">
                <a class="auth-back" href="./forgot-pin" aria-label="Back"><i class="ti ti-arrow-left" aria-hidden="true"></i></a>
                ...
                <h1 id="verifyPinTitle" class="pin-title">Enter Verification Code</h1>
                ...
                <form method="post" action="./verify-pin-code" id="verifyCodeForm" autocomplete="off" novalidate>
                ...
                <form method="post" action="./verify-pin-code" class="resend-form">
                    <input type="hidden" name="csrf_token" value="<?= $escape($csrfToken) ?>">
